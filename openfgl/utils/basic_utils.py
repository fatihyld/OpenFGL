...
def load_client(args, client_id, data, data_dir, message_pool, device):
    ...
    elif args.fl_algorithm == "fedala_s":
        from openfgl.flcore.fedala_s.client import FedALASClient
        return FedALASClient(args, client_id, data, data_dir, message_pool, device)
...
def load_server(args, global_data, data_dir, message_pool, device):
    ...
    if args.fl_algorithm == "isolate":
        ...
        from openfgl.flcore.fedala_s.server import FedALAS_Server
        return FedALAS_Server(args, global_data, data_dir, message_pool, device)
    elif args.fl_algorithm == "fedala":
